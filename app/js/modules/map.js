...
const mapMediaWidth = window.matchMedia('(min-width: 1025px)');

const mapMediaHandler = () => {
	if (mapMediaWidth.matches) {
...
mapMediaHandler(mapMediaWidth);
mapMediaWidth.addListener(mapMediaHandler);